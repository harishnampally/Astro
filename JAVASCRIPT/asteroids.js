...
{
    images[i].setAttribute("src","../ASSET/Images/Asteroids/"+i+".jpg");
...
var imgarr=["0.jpg","1.jpg","2.jpg","3.jpg","4.jpg","5.jpg","6.jpg","7.jpg","8.jpg"]
        function inc()
        {
            ...
            {
                indval=0;
            document.getElementById("header").style.backgroundImage="url(../ASSET/Images/Asteroids/navigate/"+imgarr[indval]+")";
            }
            else
            {
                document.getElementById("header").style.backgroundImage="url(../ASSET/Images/Asteroids/navigate/"+imgarr[indval]+")";
        ...
        function openImg(pic,name,info)
        {
            ...
            document.getElementById("subWindowImage").src='../ASSET/Images/Asteroids/'+pic+".jpg"
